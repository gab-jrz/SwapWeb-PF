                ...
                <div className="position-relative" style={{ display: "inline-block" }}>
                  <button
                    ...
                    onClick={() => {
                      ...
                      if (next) {
                        // Cerrar otros menús cuando se abre donaciones
                        setMenuOpen(false);
                        setCategoryMenuOpen(false);
                        setNotificationDropdownOpen(false);
                      }
                    ...
                    style={{
                      background: donacionesMenuOpen 
                        ? (darkMode ? "rgba(139, 92, 246, 0.2)" : "rgba(59, 130, 246, 0.15)")
                        : "none",
                      border: "none",
                  ...
                  >
                    ...
                    <svg
                      ...
                      fill="none"
                      style={{
                        transform: donacionesMenuOpen ? "rotate(180deg)" : "rotate(0deg)",
                  ...
                  {donacionesMenuOpen && (
                    ...
                    >
                      ...
                      <div style={{ 
                        height: "1px", 
                        background: darkMode ? "#444" : "#dee2e6", 
                        margin: "8px 20px" 
                      }}></div>
                      <button
                        className="dropdown-item"
