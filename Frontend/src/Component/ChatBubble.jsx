    ...
    >
      ...
      <div
        ...
        style={{
          ...
          color: '#23272f',
          borderRadius: 18,
          padding: (mensaje.imagen || mensaje.imagenNombre) ? '8px 10px 6px 10px' : '10px 16px',
          maxWidth: 320,
          minWidth: 60,
      ...
      >
        {/* Imagen si hay */}
        { (mensaje.imagenNombre || mensaje.imagen) && (() => {
            const raw = mensaje.imagenNombre || mensaje.imagen;
            let src = raw;
        ...
        {/* Badge de producto/donación relacionado SOLO TEXTO */}
        {(mensaje.donacionTitle || (fromMe && mensaje.productoOfrecido) || (!fromMe && mensaje.productoTitle)) ? (
          <div style={{ marginBottom: 6, marginTop: 2 }}>
            <span
              style={{
                ...
                alignItems: 'center',
                gap: 6,
                background: mensaje.donacionTitle ? '#fce4ec' : (fromMe ? '#e0f7fa' : '#ffe0b2'),
                color: mensaje.donacionTitle ? '#c2185b' : (fromMe ? '#009688' : '#b26a00'),
                borderRadius: 7,
                padding: '2px 10px',
                fontWeight: 600,
                fontSize: 13,
                boxShadow: '0 1px 2px #0001',
                border: mensaje.donacionTitle ? '1.5px solid #e91e63' : (fromMe ? '1.5px solid #00bcd4' : '1.5px solid #ffb300'),
                maxWidth: 210,
                whiteSpace: 'nowrap',
                overflow: 'hidden',
            ...
            >
              {mensaje.donacionTitle ? `❤️ ${mensaje.donacionTitle}` : (fromMe ? mensaje.productoOfrecido : mensaje.productoTitle)}
            </span>
          </div>
        ):null}
