...
const TransactionCard = ({ transaccion, currentUserId, onDelete, onRate, onRepublish, isDonation = false, deliveryDate = null }) => {
      ...
      <div className="transaction-info" style={{flex:1,minWidth:0}}>
        ...
        <div style={{
          ...
          <span style={{
            ...
            backgroundClip: 'text'
          }}>{isDonation ? 'Donación entregada' : 'Intercambio Completado'}</span>
        </div>
