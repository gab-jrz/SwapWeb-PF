        ...
        <div className="category-indicator" style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <span style={{ fontSize: '18px' }}>
              {categorias.find(cat => cat.id === selectedCategory)?.icon || '🏷️'}
            </span>
            <span style={{ fontWeight: '600' }}>
              Mostrando: {getCategoryName(selectedCategory)}
            </span>
            <span style={{ 
              ...
              <div className="col-12">
                <div className="advanced-filters-panel" style={{
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6 mb-3">
                      <label className="form-label fw-bold">🏷️ Categoría</label>
                      <select 
                        className="form-select"
                  ...
                  <div className="d-flex justify-content-between align-items-center mt-3">
                    <div className="text-muted">
                      <small>📊 {productosOrdenados.length} resultados encontrados</small>
                    </div>
