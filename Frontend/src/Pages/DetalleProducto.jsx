          ...
          <button
            ...
            onClick={() => {
              if (location?.state?.fromChat) {
                const backTo = location.state.backTo || '/perfil';
                const backState = location.state.backState || { activeTab: 'mensajes' };
            ...
            aria-label="Volver"
            title={location?.state?.fromChat ? 'Volver al chat' : 'Volver al inicio'}
          >
