...
const Editar = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const telefonoLimpio = formData.telefono ? formData.telefono.toString().replace(/[^0-9]/g, '') : '';
      console.log('📞 Teléfono original:', formData.telefono);
      ...
      // Mapear provincia para el frontend (sin zona)
      const mappedUser = {
        ...updatedUser,
        provincia: updatedUser.provincia,
        ubicacion: updatedUser.provincia
      };
      ...
      // Mostrar botón para volver al perfil
      setTimeout(() => {
        setNotificacion({
          mostrar: true,
          mensaje: 'Datos actualizados correctamente. ¿Deseas volver a tu perfil?',
          tipo: 'exito',
        ...
        {notificacion.mostrar && (
          <div className={`notificacion ${notificacion.tipo}`}>
            ...
            <div className="notificacion-botones">
              {notificacion.mostrarBotonPerfil && (
                <button 
