...
// Lista básica de provincias argentinas, puedes añadir o quitar según necesites
const PROVINCIAS = [
...
const Editar = () => {
    ...
    const fetchUserData = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          ubicacion: (userDataFromDB.ubicacion || userDataFromDB.zona) || 'Tucumán',
  ...
  const handleCancel = () => {
    setFormData({
      ...
      telefono: userData.telefono === null ? '' : userData.telefono,
      ubicacion: userData.zona || 'Tucumán',
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/users/${userData.id}`, {
        ...
        body: JSON.stringify({
          ...
          imagen: imageData,
          ubicacion: undefined // evitar duplicación
        }),
      });
